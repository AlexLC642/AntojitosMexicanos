        ...
        return (
          <div key={hourIdx} className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div 
              ...
              className="flex items-center justify-between bg-zinc-900 border-l-4 border-red-600 px-8 py-6 rounded-r-3xl border-y border-r border-zinc-800 cursor-pointer group hover:bg-zinc-800/50 transition-all"
            >
              <div className="flex items-center gap-4">
                <ChevronDown className={cn(
                  "h-6 w-6 text-zinc-500 transition-transform duration-500",
                  collapsedHours[hourIdx] ? "-rotate-90 text-red-500" : "text-zinc-300"
                )} />
                <div>
            ...
            {!collapsedHours[hourIdx] && (
              <div className="space-y-6 animate-in slide-in-from-top-2 fade-in duration-500">
                {/* Quick Stats Grid */}
